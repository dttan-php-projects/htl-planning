				...
				<td colspan="" class="none_border">
					<table class="" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0"> <!-- table 1-->
						...
						<tr style="height:5%" class="barcode bold pt9 padding">
							...
							<td style="width:60%" colspan="14" class="aleft pt6 xanh_3 none_border"><?php echo $REMARK_1;?></td>
						</tr>
						<tr style="height:9%">
							<td colspan="17" class="none_border none_border">
								<table class="" style="width:100%;height:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
									<tr class="bold pt9 padding">
										...
										<td style="width:32%" class="none_border aleft hong_1" colspan="7"><?php echo $SHIP_TO;?></td>
							...
							<td colspan="17" class="none_border ">
								<table class="bold pt8 xanh_3" style="width:100%;height:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
									...
									<tr class="pt7 cam_1" style="height:30px;">
										...
										<td colspan="">Discription</td>
										<td colspan="">EA - SHT</td>
										<td colspan="">YD</td>
										<td colspan="">MT</td>
									...
									<?php
										if(!empty($arr_supply)){
											...
											foreach($arr_supply as $material){
												...
												$ITEM_DES = $material['ITEM_DES'];
												$QTY = $material['QTY'];
												$TOTAL_QTY+=$QTY;
												$MATERIAL_CODE = $material['MATERIAL_CODE'];
												$MATERIAL_DES = $material['MATERIAL_DES'];
												$EA_SHT = $material['EA_SHT'];
												$YD = $material['YD'];
												$MT = $material['MT'];
									...
									<tr class="pt6">
										...
										<td class="pt7" style="width:5%" colspan=""><?php echo $ITEM;?></td>
										<td style="width:10%" colspan=""><?php echo $INTERNAL_ITEM;?></td>
										<td style="width:4%" colspan=""><?php echo $RBO;?></td>
										<td style="width:4%" colspan=""><?php echo $ITEM_DES;?></td>
										<td class="pt7" style="width:4%" colspan=""><?php echo $QTY>0?number_format($QTY):'-';?></td>
										<td style="width:8%" colspan=""><?php echo $MATERIAL_CODE;?></td>
										<td style="width:10%" colspan=""><?php echo $MATERIAL_DES;?></td>
										<td class="pt7" style="width:5%" colspan=""><?php echo $EA_SHT>0?number_format($EA_SHT):'-';?></td>
										...
										<td colspan=""><?php echo $INK_DES;?></td>
									...
									<tr class="pt6">
										...
										<td style="width:4%" colspan="">&nbsp;</td>
										<td style="width:4%" colspan="">&nbsp;</td>
										<td class="pt7" style="width:10%" colspan="">&nbsp;</td>
										<td colspan="">&nbsp;</td>
										<td class="pt7" style="width:3%" colspan="">&nbsp;</td>
									</tr>
									<?php }} ?>
