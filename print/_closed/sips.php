							...
							<td colspan="17" class="none_border ">
								<table class="bold pt8 xanh_3" style="width:100%;height:100%;border-collapse:collapse;" cellpadding="0" cellspacing="0">
									...
									<tr class="pt6">
										...
										<td class="pt7" style="width:10%" colspan=""><?php echo $SO_LINE;?></td>
										<td class="pt7" style="width:15%" colspan=""><?php echo $ITEM;?></td>
										<td style="width:15%" colspan="3"><?php echo $INTERNAL_ITEM;?></td>
										<td class="pt7" style="width:6%" colspan=""><?php echo $QTY>0?number_format($QTY):'-';?></td>
										<td  colspan="2"><?php echo $MATERIAL_CODE;?></td>
										<td class="pt7" style="width:10%" colspan="3"><?php echo $MATERIAL_QTY>0?number_format($MATERIAL_QTY):'-';?></td>
										<td style="width:6%" colspan=""><?php echo $LENGTH;?></td>
										<td style="width:6%" colspan=""><?php echo $WIDTH;?></td>
										<td class="pt7" style="width:13%" colspan="2"><?php echo $INK_CODE;?></td>
										<td class="pt7" style="width:6%" colspan=""><?php echo $INK_QTY>0?number_format($INK_QTY):'-';?></td>
									</tr>
									<?php }} ?>
									<!-- end material -->
