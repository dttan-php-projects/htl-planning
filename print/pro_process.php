...
foreach ($arr_process as $key => $process){
	...
	*/
	if(!empty($process['PROCESS_2'])&&($process['PROCESS_2']==$process['PROCESS_1'])){
		$COUNT_DUP_PROCESS_2++;
	}
	if(!empty($process['PROCESS_3'])&&($process['PROCESS_3']==$process['PROCESS_1']||$process['PROCESS_3']==$process['PROCESS_2'])){
		$COUNT_DUP_PROCESS_3++;
	}
	if(!empty($process['PROCESS_4'])&&($process['PROCESS_4']==$process['PROCESS_3']||$process['PROCESS_4']==$process['PROCESS_2']||$process['PROCESS_4']==$process['PROCESS_1'])){
		$COUNT_DUP_PROCESS_4++;
	}
}
