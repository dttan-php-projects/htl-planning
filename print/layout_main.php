        ...
        <table style="width:99%;height:99%;border-collapse:collapse;margin-left:0%;"  cellpadding="0" cellspacing="0">
							...
							<td style="width:100%" colspan="4" class="none_border">
								<table class="" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0">
									<tr class="">
										...
										<td class="<?php echo $pt8_b;?> none_border" colspan="1"><?php echo $REMARK_1 . ' ' . $REMARK_MLA;?></td>
										<td class="<?php echo $pt8_b;?> none_border" id="UOM"><?php // hiển thị remark UOM tại đây, sử dụng javascript ?></td>
									</tr>
								</table>
							</td>
						</tr>
						<tr class="">
							<td colspan="4" class="<?php echo $pt14_b;?> <?php echo $non_border;?>"><span id="fru-ic">&nbsp;&nbsp;</span>&nbsp;&nbsp; JOB SHEET/ LỆNH SẢN XUẤT HTL </td>
						</tr>
						<tr class="">
							<td colspan="2" class="<?php echo $non_border;?> aleft"><?php echo $BARCODE;?></td>
							<td class="<?php echo $a_pt8_b;?> <?php echo $non_border;?>" colspan="1" style="width:28%">Type machine/Máy:</td><td class="<?php echo $a_pt8_b;?> <?php echo $non_border;?>" colspan="1"><?php echo $MACHINE_TYPE;?></td>
						</tr>
						<tr class="">
							<td class="<?php echo $a_pt8_b;?> <?php echo $non_border;?>" colspan="1" style="width:20%">Date/Ngày Làm Lệnh:</td><td colspan="1" class="aleft <?php echo $non_border;?>"><?php echo $CREATED_DATE;?></td>	
			...
			<tr>
				<td colspan="" class="<?php echo $non_border ;?>">
					<table class="" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0">
						<tr class="">
							<td colspan="3" class="<?php echo $a_pt8_b;?> <?php echo $non_border;?>">Label Size/K.T nhãn:</td>
							...
							<td colspan="1" class="<?php echo $non_border;?>"><?php echo !empty($LABEL_SIZE_ARR[4])?$LABEL_SIZE_ARR[4]:'&nbsp;';?></td>
							<td colspan="1" class="<?php echo $non_border;?>"><?php echo !empty($LABEL_SIZE_ARR[5])?$LABEL_SIZE_ARR[5]:'&nbsp;';?></td>
						...
						<tr class="">
							...
							<td colspan="1" style="width:13%;" class="<?php echo $pt8_b;?>"><?php echo (!empty($arr_supply[1])&&!$REMOVE_ITEM_PROCESS_2)?$arr_supply[1]['ORACLE_ITEM']:'&nbsp;';?></td>
							<td colspan="1" style="width:13%;" class="<?php echo $pt8_b;?>"><?php echo (!empty($arr_supply[2])&&!$REMOVE_ITEM_PROCESS_3)?$arr_supply[2]['ORACLE_ITEM']:'&nbsp;';?></td>
							<td colspan="1" style="width:13%;" class="<?php echo $pt8_b;?>"><?php echo (!empty($arr_supply[3])&&!$REMOVE_ITEM_PROCESS_4)?$arr_supply[3]['ORACLE_ITEM']:'&nbsp;';?></td>
						</tr>
						<?php
						$STT = 0;
						...
						<tr class="">
							...
							<td colspan="2" <?php echo ($PROCESS_1!='&nbsp;')?'class="nen_vang"':'';?>><?php echo $PROCESS_1;?><?php echo !empty($STT_2)?$STT_1:'';?></td>
							<td colspan="1" <?php echo ($PROCESS_2!='&nbsp;')?'class="nen_vang"':'';?>><?php echo $PROCESS_2;?><?php echo $STT_2;?></td>
							<td colspan="1" <?php echo ($PROCESS_3!='&nbsp;')?'class="nen_vang"':'';?>><?php echo $PROCESS_3;?><?php echo $STT_3;?></td>
							<td colspan="1" <?php echo ($PROCESS_4!='&nbsp;')?'class="nen_vang"':'';?>><?php echo $PROCESS_4;?><?php echo $STT_4;?></td>
				...
				<td colspan="" class="<?php echo $non_border ;?>">
					<table class="padding" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0">
						...
						<tr class="">
							...
							<td colspan="1" class="nen_vang <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $SCRAP_DESIGN ;?>%</td>
						</tr>
						<tr class="">
							...
							<td colspan="1" class="nen_cam <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $SCRAP_SETUP ;?>%</td>
						</tr>
						<tr class="">
							...
							<td colspan="1" class="nen_vang <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $SCRAP_ERROR ;?>%</td>
						</tr>
						<tr class="">
							...
							<td colspan="1" class="nen_cam <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $SCRAP_PRINTING ;?>%</td>
						</tr>
						<tr class="">
							...
							<td colspan="1" class="nen_vang <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $TOTAL_SCRAP ;?>%</td>
						</tr>
						<tr class="">
							...
							<td colspan="1" class="nen_cam <?php echo $a_pt8_b;?> <?php echo $non_border ;?>"><?php echo $TIME_RUNNING ;?></td>
						</tr>
						<!-- end process-->
					</table>
				</td>
				...
				<td colspan="" class="<?php echo $non_border ;?>">
					<table class="padding" style="width:100%;height:100%;border-collapse:collapse;"  cellpadding="0" cellspacing="0">	
						...
						<tr class="">
							...
							<td colspan="8" class="aleft">TUÂN THEO MẪU ĐÃ APPROVED. <?php echo $remarkSpecialItem; ?></td>						
						</tr>
						<tr class="">
...
<script>
	...
	//reload fru-ic
	document.getElementById("fru-ic").innerHTML = '<span style="color:red;font-weight:bold;font-size:22px;"><?php echo (!empty($remarkFRUIC) ) ? $remarkFRUIC : '' ; ?></span>';
